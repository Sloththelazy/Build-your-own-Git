...
class HashObjectCommand {
    ...
    execute() {
        // 1. Make sure that file is there at the filepath given
        ...
        // 3. create blob for the file at the given file address
        ...
        // 5. If flag = -w then write file after compressing it
